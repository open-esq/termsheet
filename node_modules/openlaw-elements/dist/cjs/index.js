...
var renderSuggestion = function renderSuggestion(suggestion) {
  return React.createElement("div", null, suggestion.address);
};
...
function (_React$PureComponent) {
  ...
  function Address(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "isDataValid", false);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onSuggestionsClearRequested", function () {
      _this.setState({
        result: []
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onSuggestionsFetchRequested", function (request) {
      _this.props.apiClient.searchAddress(request.value).then(function (result) {
        _this.setState({
          result: result
        });
      });
    ...
    var self = assertThisInitialized(assertThisInitialized(_this));

    self.onChange = _this.onChange.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.submitAddress = _this.submitAddress.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
  ...
  createClass(Address, [{
    ...
    value: function onChange(event, autosuggestEvent) {
      ...
      var newValue = autosuggestEvent.newValue,
          method = autosuggestEvent.method;

      if (method === 'click' || method === 'enter') {
        var place = this.state.result.find(function (obj) {
          return obj.address === newValue;
        });

        if (place) {
          this.props.apiClient.getAddressDetails(place.placeId).then(this.submitAddress).then(function () {
            _this2.isDataValid = true;
          }).catch(function () {
            _this2.isDataValid = false;
          });
        }
      } else {
    ...
    key: "submitAddress",
    value: function submitAddress(address) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        var _this3$props = _this3.props,
            name = _this3$props.name,
            openLaw = _this3$props.openLaw;
        ...
        try {
          if (address) {
            _this3.setState({
              ...
              _this3.props.onChange(name, openLaw.createAddress(address));
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          cleanName = _this$props.cleanName;
      var additionalClassName = this.state.validationError ? ' is-error' : '';
      var inputProps = {
        autoComplete: 'new-password',
        className: "".concat(this.props.textLikeInputClass).concat(cleanName).concat(additionalClassName),
        onChange: this.onChange,
        onKeyUp: function onKeyUp(event) {
          return _this4.props.onKeyUp ? _this4.props.onKeyUp(event, _this4.isDataValid) : undefined;
        },
      ...
      return React.createElement("div", {
        className: "contract-variable ".concat(cleanName, "-address")
      }, React.createElement("label", null, React.createElement("span", null, description), React.createElement(dist$3, {
...
defineProperty(Address, "propTypes", process.env.NODE_ENV === 'production' ? null : {
  ...
  textLikeInputClass: propTypes.string.isRequired
});
...
function (_React$PureComponent) {
  ...
  createClass(Choice, [{
    key: "choiceValuesOption",
    value: function choiceValuesOption(choice) {
    ...
    value: function onChange(event) {
      ...
      if (getValidity(name, eventValue)) {
        this.setState({
          ...
          _this2.props.onChange(name, eventValue);
        });
      } else {
        this.setState({
          currentValue: eventValue,
    ...
    value: function render() {
      ...
      var additionalClassName = this.state.validationError ? ' is-error' : '';
      return React.createElement("div", {
        className: "contract-variable choice"
      }, React.createElement("label", {
        className: "label"
      }, React.createElement("span", null, description), React.createElement("select", {
        value: this.state.currentValue,
        onChange: this.onChange,
        className: "".concat(this.props.textLikeInputClass).concat(cleanName).concat(additionalClassName)
      }, React.createElement("option", {
        value: ""
      }, "-- Please choose from the list --"), choiceValues.map(this.choiceValuesOption))));
    }
  }]);
  ...
  createClass(Identity, [{
    ...
    value: function componentDidMount() {
      var _this$props = this.props,
          getValidity = _this$props.getValidity,
          name = _this$props.name,
          openLaw = _this$props.openLaw,
          savedValue = _this$props.savedValue;

      try {
        if (this.props.savedValue) {
          var identity = getValidity(name, savedValue);
          this.setState({
      ...
      try {
        if (!eventValue) {
          this.setState({
            ...
            _this2.props.onChange(name, undefined);
          ...
          this.props.onChange(name, openLaw.createIdentityInternalValue('', eventValue));
    ...
    value: function render() {
      ...
      var additionalClassName = this.state.validationError ? ' is-error' : '';
      return React.createElement("div", {
        className: "contract-variable identity"
      }, React.createElement("label", null, React.createElement("span", null, description), React.createElement("input", {
        className: "".concat(this.props.textLikeInputClass).concat(cleanName, " ").concat(cleanName, "-email").concat(additionalClassName),
        onChange: this.onChange,
        onKeyUp: function onKeyUp(event) {
          return _this3.props.onKeyUp ? _this3.props.onKeyUp(event, _this3.isDataValid) : undefined;
        },
        placeholder: description,
        title: description,
        type: "email",
...
function (_React$PureComponent) {
  ...
  function DatePicker(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "id", void 0);

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "flatpickr", void 0);

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "flatpickrRef", React.createRef());

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "state", {
      enableTime: _this.props.enableTime
    });

    var cleanName = _this.props.cleanName;
    var timestamp = new Date().getTime().toString();
    _this.id = "date_".concat(cleanName, "_").concat(timestamp);
  ...
  createClass(DatePicker, [{
    ...
    value: function componentDidMount() {
      ...
      var options = {}; // display in a friendly format (e.g. January, 1, 1971)

      options.altInput = true;
      options.dateFormat = 'Z'; // allow time selection 00:00, AM/PM
      ...
      if (this.props.textLikeInputClass) {
        ...
        options.altInputClass = "".concat(this.props.textLikeInputClass, " ").concat(cleanName);
      }
    ...
    key: "onChange",
    value: function onChange(selectedDates) {
      var name = this.props.name;
    ...
    key: "shouldShowIOSLabel",
    value: function shouldShowIOSLabel() {
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        className: "contract-variable"
      }, React.createElement("label", null, React.createElement("span", null, description), React.createElement("input", {
        id: this.id,
        placeholder: description,
        ref: this.flatpickrRef
      })), this.shouldShowIOSLabel() && React.createElement("span", {
        className: "ios-label"
      }, description));
    }
  }]);
  ...
  return (
    ...
    function (module, exports, __webpack_require__) {
      ...
      function containCrop(previousCrop, crop, imageAspect) {
        var contained = _extends({}, crop); // Don't let the crop grow on the opposite side when hitting an x image boundary.
...
function (_Component) {
  ...
  function ImageCrop() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getDimensionsFromTarget", function (_ref3) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getReactCropProps", function (props) {
      var _ref4 = props || {},
          crop = _ref4.crop,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setImageSource", function (dataURL) {
      var image = new Image();
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onSelectFile", function (event) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onCropChange", function (crop) {
      _this.setState({
        crop: crop
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onComplete", function (crop, pixelCrop) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onImageDelete", function () {
      _this.setState({
        src: ''
      }, function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onImageLoaded", function (image, pixelCrop) {
      _this.setState({
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "renderReactComp", function (props) {
  ...
  createClass(ImageCrop, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", null, this.props.children ? this.props.children({
...
function (_React$PureComponent) {
  ...
  function ImageInput(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "fileRef", React.createRef());
    ...
    self.handleFileChange = _this.handleFileChange.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.handleImageCancel = _this.handleImageCancel.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.handleImageCrop = _this.handleImageCrop.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.handleImageDelete = _this.handleImageDelete.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.handleShowCropper = _this.handleShowCropper.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.handleToggleModal = _this.handleToggleModal.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.updateImage = _this.updateImage.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
  ...
  createClass(ImageInput, [{
    ...
    value: function componentDidUpdate(_ref) {
      ...
      if (!this.state.validationError && this.props.savedValue !== prevSavedValue) {
        this.setState({
    ...
    key: "shouldDisableEditButton",
    value: function shouldDisableEditButton(image) {
      var isFromRemote = /^http.+\.(gif|png|tiff|bmp|jpg)/.test(image); // if image is from remote,
    ...
    key: "getModalDisplayStyle",
    value: function getModalDisplayStyle() {
      return {
    ...
    key: "handleImageCancel",
    value: function handleImageCancel(event) {
      event.preventDefault();
    ...
    value: function handleImageDelete() {
      ...
      this.setState({
        ...
        var fileInputRef = _this3.fileRef.current;
        if (fileInputRef) fileInputRef.value = '';
    ...
    key: "handleShowCropper",
    value: function handleShowCropper() {
      this.setState({
        showCropper: true
      });
    }
    ...
    value: function resizeImageSource(dataURL) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        image.addEventListener('load', function () {
          ...
          var src = _this4.drawImageToDataURL({
            image: image,
            height: height,
            width: width
          });
    ...
    key: "updateImage",
    value: function () {
      var _updateImage = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee() {
        var _this5 = this;

        var _this$props, getValidity, name, _this$state, croppedValue, currentValue, imageDataURL, resizedImageDataURL, validity, isImageDataValid;

        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$props = this.props, getValidity = _this$props.getValidity, name = _this$props.name;
                ...
                _context.prev = 3;
                _context.next = 6;
                return this.resizeImageSource(imageDataURL);
              ...
              case 12:
                validity = getValidity(name, resizedImageDataURL); // if the valid string either has length, or is empty, it's valid

                isImageDataValid = validity && validity.length > 0 || validity === '' && validity.length === 0;
                ...
                if (isImageDataValid) {
                  if (resizedImageDataURL) {
                    this.setState({
                      ...
                      _this5.props.onChange(name, resizedImageDataURL);
                    });
                  } else {
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          cleanName = _this$props2.cleanName,
          description = _this$props2.description;
      var disableEditRemoteImage = this.state.disableEditRemoteImage;
      /* eslint-disable complexity */

      return React.createElement("div", {
        className: "contract-variable file"
      }, this.props.savedValue ? React.createElement("button", {
        className: "image",
        onClick: this.handleToggleModal,
        disabled: disableEditRemoteImage
      }, "Edit ".concat(description)) : React.createElement(Fragment, null, React.createElement("label", {
        htmlFor: "image-".concat(cleanName)
      }, React.createElement("span", null, "Select ".concat(description)), React.createElement("input", {
        accept: "image/png, image/jpeg, image/tiff, image/bmp, image/gif",
        id: "image-".concat(cleanName),
        className: "image",
        onChange: this.handleFileChange,
        ref: this.fileRef,
        type: "file"
      }))), this.state.showModal && this.state.currentValue && React.createElement("div", {
        className: "modal",
        style: this.getModalDisplayStyle()
      }, React.createElement("div", {
        className: "modal-form"
      }, React.createElement(Fragment, null, React.createElement(ImageCrop, {
        crop: {
          x: 0,
          y: 0,
          width: 100,
        ...
        className: "ol-modalconfirm-buttons"
      }, React.createElement("button", {
        className: "ol-modalconfirm-primary button is-info-new",
        onClick: function onClick() {
          return _this6.updateImage();
        }
      }, "Save"), React.createElement("div", {
        className: "ol-modalconfirm-buttons"
      }, this.props.savedValue && React.createElement("a", {
  ...
  createClass(LargeText, [{
    ...
    value: function onChange(event) {
      ...
      this.setState({
        ...
        _this2.props.onChange(name, eventValue || undefined);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return React.createElement("div", {
        className: "contract-variable"
      }, React.createElement("label", null, React.createElement("span", null, description), React.createElement("textarea", {
        className: "".concat(this.props.textLikeInputClass).concat(cleanName),
        onChange: this.onChange,
        placeholder: description,
        title: description,
        value: this.state.currentValue
...
function (_React$PureComponent) {
  ...
  function YesNo(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "noRef", React.createRef());

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "yesRef", React.createRef());
  ...
  createClass(YesNo, [{
    ...
    value: function onChange(event) {
      ...
      this.setState({
        ...
        _this3.props.onChange(name, eventValue, true);
      });
    ...
    value: function render() {
      var _this$props = this.props,
          cleanName = _this$props.cleanName,
          description = _this$props.description;
      var additionalClass = this.state.currentValue ? ' conditional-set' : '';
      return React.createElement("div", {
        className: "contract-variable contract-question".concat(additionalClass)
      }, React.createElement("label", {
        className: "label"
      }, description), React.createElement("div", null, React.createElement("label", null, React.createElement("input", {
        className: cleanName,
        onChange: this.onChange,
        name: cleanName,
        ref: this.yesRef,
        type: "radio",
        value: "true"
      }), React.createElement("span", null, "Yes")), React.createElement("label", null, React.createElement("input", {
        className: cleanName,
        name: cleanName,
        onChange: this.onChange,
        ref: this.noRef,
...
var getChoiceValuesCached = cacheValue(deepEqual_1);
var variableCache = {};
var executionResultCached;
var openLawCached;

var attemptCheckValidity = function attemptCheckValidity(name, value) {
  try {
...
var InputRenderer = function InputRenderer(props) {
  ...
  var _getVariableData = getVariableData(variable, openLaw),
      ...
      name = _getVariableData.name; // store latest executionResult for access outside React


  executionResultCached = executionResult; // store openLaw for access outside React

  if (!openLawCached) openLawCached = openLaw; // store { [name]: variable } for access outside React

  variableCache[name] = variable; // Choice type detection is different
...
function (_React$Component) {
  ...
  function Structure(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(Structure).call(this, props));

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "openLaw", _this.props.openLaw);
  ...
  createClass(Structure, [{
    ...
    value: function generateInput(subVariable) {
      ...
      return React.createElement("div", {
        className: "structure-variable-row",
    ...
    value: function onChange(key, value) {
      ...
      try {
        if (variable) {
          var savedValue = this.props.savedValue;
          var currentValue = this.openLaw.setStructureFieldValue(variable, key, value, savedValue || undefined, this.props.executionResult);
          this.setState({
            currentValue: currentValue,
            validationError: false
          }, function () {
            _this2.props.onChange(variableName, currentValue);
          });
        } else {
          this.setState({
            currentValue: '',
            ...
            _this2.props.onChange(_this2.openLaw.getName(variable));
          });
        }
      } catch (error) {
        this.setState({
    ...
    value: function render() {
      ...
      var fields = this.openLaw.getStructureFieldDefinitions(variable, this.props.executionResult).map(function (field) {
        return _this3.generateInput(field);
      });
      return React.createElement("div", {
        className: "contract-variable structure-variable ".concat(cleanName)
      }, fields);
    }
  }]);
...
function (_React$Component) {
  ...
  function Collection(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "uniqueCollectionIds", []);
    ...
    self.add = _this.add.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.onChange = _this.onChange.bind(assertThisInitialized(assertThisInitialized(_this)));
    self.onEnter = _this.onEnter.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
  ...
  createClass(Collection, [{
    ...
    value: function add() {
      var variable = this.props.variable;
      var variableName = this.openLaw.getName(variable);
      var newValue = this.openLaw.addElementToCollection(variable, this.props.savedValue, this.props.executionResult);
      var size = this.openLaw.getCollectionSize(variable, newValue, this.props.executionResult);
    ...
    key: "generateInput",
    value: function generateInput(index) {
      var _this2 = this;
      ...
      var executionResult = this.props.executionResult; // append new client-side unique React key, if none exists

      if (!this.uniqueCollectionIds[index]) this.addUniqueCollectionId(uuidv4());
      return React.createElement("div", {
        className: "collection-variable-row",
      ...
      }, React.createElement(TimesSVG, null)));
    }
  }, {
    key: "handleElementFocus",
    value: function handleElementFocus() {
      if (this.state.focusIndex !== null) {
        var index = this.state.focusIndex >= 0 ? this.state.focusIndex : -1;
        if (index === -1) return; // TODO should replace things like this with a ref
    ...
    value: function onChange(key, value) {
      ...
      var variable = this.props.variable;
      var variableName = this.openLaw.getName(variable);
      var index = parseInt(key.replace(variableName + '_', ''));

      try {
        if (variable) {
          var currentValue = this.openLaw.setElementToCollection(value, index, variable, this.props.savedValue, this.props.executionResult);
          this.setState({
            currentValue: currentValue,
            validationError: false
          }, function () {
            _this3.props.onChange(variableName, currentValue);
          });
        } else {
          this.setState({
            currentValue: '',
            ...
            _this3.props.onChange(_this3.openLaw.getName(variable));
          });
        }
      } catch (error) {
        this.setState({
    ...
    value: function onEnter(event) {
      var isDataValid = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    value: function remove(index) {
      var variable = this.props.variable;
      var variableName = this.openLaw.getName(variable);
      var newValue = this.openLaw.removeElementFromCollection(index, variable, this.props.executionResult, this.props.savedValue); // delete client-side unique React key
    ...
    value: function render() {
      ...
      var collectionSize = this.openLaw.getCollectionSize(variable, this.props.savedValue, this.props.executionResult);
      var variables = [];
      ...
      return React.createElement("div", {
        ...
        className: "collection-variable-description"
      }, description), variables, React.createElement("div", {
...
var GetSections = function GetSections(variables, sectionVariables, sections, config) {
  ...
  var mappedSections = sections.map(function (section, index) {
    ...
    if (currentSectionVariables.length) {
      ...
      if (sectionTransform) {
        return objectSpread({}, sectionTransform(section, index), {
  ...
  if (unsectionedVariables.length) {
    ...
    if (sectionTransform) {
      ...
      sectionData = objectSpread({}, sectionTransform(getUnsectionedTitle(config.unsectionedTitle), index), {
...
var renderInputs = function renderInputs(props) {
  var apiClient = props.apiClient,
      _props$executionResul = props.executionResult,
      executionResult = _props$executionResul === void 0 ? {} : _props$executionResul,
      _props$onChangeFuncti = props.onChangeFunction,
      onChangeFunction = _props$onChangeFuncti === void 0 ? function () {} : _props$onChangeFuncti,
      ...
      _props$variable = props.variable,
      variable = _props$variable === void 0 ? {} : _props$variable;
  var savedValue = parameters[openLaw.getName(variable)] || '';
  var cleanName = openLaw.getCleanName(variable);
  var textLikeInputClass = props.textLikeInputClass ? "".concat(props.textLikeInputClass, " ") : ''; // Structure: can contain all types of inputs in <InputRenderer />
    ...
    if (renderSections) {
      var inputsChildrenComponent = function inputsChildrenComponent() {
        return variables.map(function (name) {
          ...
          return renderInputs(objectSpread({
            variable: variable
          }, props));
        });
      };

      return renderSections(objectSpread({
...
var OpenLawForm = function OpenLawForm(props) {
  ...
  if (sections.length) {
    formContent = renderSectionsAndInputs(objectSpread({
      sections: sections,
